...
amigaos-clean:
	@rm -f lib/amigaos/*.o
	@rm -f lib/amigaos/libglfw.a
	@cd examples; $(MAKE) -f Makefile.amigaos.gcc clean


# Cleanup for AmigaOS
amigaos-gcc:
	@cd lib/amigaos; $(MAKE) -f Makefile.amigaos.gcc
	@cd examples;   $(MAKE) -f Makefile.amigaos.gcc
